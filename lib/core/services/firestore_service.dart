...
import 'package:pig_lifecycle_crm/features/pigs/data/models/farrowing_record_model.dart';
...
class FirestoreService {
  ...
  // Fetches a real-time stream for a single pig document
  Stream<Pig?> getPigStream(String pigId) {
    return _db
        .collection('pigs')
        .doc(pigId)
        .snapshots()
        .map((snapshot) => snapshot.exists ? Pig.fromSnapshot(snapshot) : null);
  }
